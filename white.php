            ...
            <div class="row">
                    ...
                    <div id="demo" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active marble-img">
                                <img src="src/images/white marble/ARABESCATO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/ARISTONE WHITE_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/CALACATTA ORO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/GLACIER WHITE_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/GOLDEN SPIDER_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/MICHEL ANGELO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/MICHEL ANGELO PINK_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/MICHEL ANGELO VENATO ORO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/STATUARIO  EXTRA_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/STATUARIO LINCOLN_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/STATUARIO VIOLA_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/STATUARIOTO_ICON.gif">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/SWISS WHITE_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/THASSOS EXTRA WHITE_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/white marble/VENATINO_ICON.jpg">
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-8 col-md-7">
                    <div class="marble-content">
                        <h2><span>white marble</span> collection</h2>
