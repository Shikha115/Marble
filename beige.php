            ...
            <div class="row">
                    ...
                    <div id="demo" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active marble-img">
                                <img src="src/images/beige marble/ANTIQUE BEIGE_IOCN.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/BEIGE SERPEGGIANT_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/BOTTICINO CLASSICO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/BOTTICINO CREMA_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/BURDUR BEIGE_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/CREMA UNITO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/CREMAAVORIOI_CON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/DI MARTINO CHIPS_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/DIANO_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/MOCA CREAM_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/MOON LIGHT_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/PALAZZIO BEIGE_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/PERLADO SICILIA_ICON.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/beige marble/WHITE EMPRESS_ICON.jpg">
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-8 col-md-7">
                    <div class="marble-content">
                        <h2><span>beige marble</span> collection</h2>
