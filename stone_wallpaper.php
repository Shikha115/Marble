            ...
            <div class="row">
                    ...
                    <div id="demo" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active marble-img">
                                <img src="src/images/stone_wallpaper marble/3d_Diamond_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/3d_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Brick_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Crakle_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Croco_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Flower_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Geo_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Leaf_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Lilly_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Linear_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Paisley_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Wave_Diagonal_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Wave_Horizontol_Icon.jpg">
                            </div>
                            <div class="carousel-item marble-img">
                                <img src="src/images/stone_wallpaper marble/Zebrino_Icon.jpg">
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-8 col-md-7">
                    <div class="marble-content">
                        <h2><span>stone wallpaper marble</span> collection</h2>
